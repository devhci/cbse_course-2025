...
public class EncapsulationExample {
    public static void main(String[] args) {
        // Creating an object of the Person class and using its getter and setter
        Person person = new Person();
        person.setName("Alice"); // Setting the name using the setter
        System.out.println("Person's name: " + person.getName()); // Accessing the name using the getter
    }
}
